        ...
        <div class="card-body">
            ...
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="idProduk" name="idProduk" value="{{ $nextProductId }}" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" id="gambar" name="image_url" accept="image/*" onchange="previewFile()" required>
                </div>
                <div class="form-group">
                    <img id="preview" src="#" alt="Preview Gambar" class="gmbrprd" style="display: none; max-width: 300px;">
                </div>
